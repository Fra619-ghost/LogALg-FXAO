...
void proceso(){
    ...
    cin >> distancia;
        ...
        if(distancia<=500){
        ...
        }if(distancia>=501 || distancia<=1000){
            ...
            cout << "Recorrió dos veces más de la distancia acordada, se le agregara un impuesto adicional del 8 porciento"<<endl;
